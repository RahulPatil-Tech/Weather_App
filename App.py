...
# Add API Key Weather
    api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=a7881050472a0bc3d65a5e7467359085"
...
#Add Search Bar
image_search = PhotoImage(file="F:\Python Project\Weather App\search_bar.png")
...
#Add Search Icon
image_search_icon=PhotoImage(file="F:\Python Project\Weather App\search_icon.png")
...
#Add Weather Logo
image_logo=PhotoImage(file="F:\Python Project\Weather App\weather_logo.png")
weather_logo=Label(image=image_logo)
weather_logo.place(x=250,y=90)

#Add Information Box
image_box=PhotoImage(file="F:\Python Project\Weather App\information_box.png")
